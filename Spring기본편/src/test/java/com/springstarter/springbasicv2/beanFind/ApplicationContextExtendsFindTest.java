...
public class ApplicationContextExtendsFindTest {
    ...
    public void findBeanParentTypeDuplicate(){
...
//        DiscountPolicy bean = ac.getBean(DiscountPolicy.class);
    ...
    void findBeanByParentTypeBeanName(){
        DiscountPolicy rat = ac.getBean("rateDiscountPolicy", DiscountPolicy.class);
        assertThat(rat).isInstanceOf(RateDiscountPolicy.class);
    }
    ...
    @Test
    @DisplayName("부모 타입을 모두 조회하기 -Object")
